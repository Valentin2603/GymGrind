...
public final class Hud extends VBox {
    ...
    private void showPanel(boolean statsVisible, boolean achievementsVisible) {
        ...
        applyHudButtonStyle(statsButton, statsVisible);
        applyHudButtonStyle(achievementsButton, achievementsVisible);
    ...
    private ToggleButton createHudButton(String text) {
        ...
        applyHudButtonStyle(button, false);
        return button;
    }

    private void applyHudButtonStyle(ToggleButton button, boolean selected) {
        button.setStyle("-fx-background-color: " + (selected ? "rgba(183, 107, 42, 0.98)" : "rgba(24, 17, 12, 0.94)") + ";"
                + "-fx-text-fill: " + (selected ? "#FFFFFF" : "#F8E5CC") + ";"
                + "-fx-background-radius: 9;"
                + "-fx-border-color: " + (selected ? "#F8D66D" : "rgba(246, 185, 77, 0.70)") + ";"
                + "-fx-border-radius: 9;"
                + "-fx-border-width: 1.3;"
